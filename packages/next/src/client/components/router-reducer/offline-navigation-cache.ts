...
// Durable storage for offline navigations mirrors the two layers of the client
// router cache. Route records describe the route tree that can be reconstructed
// for a URL. Segment records carry the prefetched RSC payloads that fill that
// tree after a hard reload through the offline fallback document.
//
